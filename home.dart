...
class HomeApp extends StatefulWidget {
  const HomeApp({ key}) : super(key: key);

  @override
  HomeApp_state createState() => HomeApp_state();
}

class HomeApp_state extends State<HomeApp> {
   var i=0;
            ...
            appBar: AppBar(
              ...
              PopupMenuButton(
                  ...
                  itemBuilder: (context) => [
                    ...
                    PopupMenuItem<int>(
                      value: 4,
                      child: ElevatedButton(child: const Text("Report for a date range",
                          style:TextStyle(color:Colors.black)),style:ElevatedButton.styleFrom(primary:Color.fromRGBO(30, 223, 212, 1),fixedSize: const Size(
                        200,
                        30,),),
                          onPressed: () {Navigator.push(
                            context,
                            MaterialPageRoute(builder:
                                (context) => Selectdaterange()),);}
                      ),
                    ),
                    PopupMenuItem<int>(
                      value: 2,
                      child: ElevatedButton(child: const Text("Daily report",
                          style:TextStyle(color:Colors.black)),style:ElevatedButton.styleFrom(primary:Color.fromRGBO(30, 223, 212, 1),fixedSize: const Size(
                        200,
                        30,),),
                          onPressed: () {Navigator.push(
                    ...
                    PopupMenuItem<int>(
                      value: 1,
                      child: ElevatedButton(child: const Text("View visitor Profile",
                          style:TextStyle(color:Colors.black)),
                          style:ElevatedButton.styleFrom(primary:Color.fromRGBO(30, 223, 212, 1),fixedSize: const Size(
                            200,
                            30,),),
                          onPressed: () {Navigator.push(
                            context,
                    ...
                    PopupMenuItem<int>(
                      value: 3,
                      child: ElevatedButton(child: const Text("Get visitors with dues",
                          style:TextStyle(color:Colors.black)),
                          style:ElevatedButton.styleFrom(primary:Color.fromRGBO(30, 223, 212, 1),fixedSize: const Size(
                            200,
                            30,),),
                    ...
                    PopupMenuItem<int>(
                      value: 5,
                      child: ElevatedButton(child: const Text("Add Pool manager",
                          style:TextStyle(color:Colors.black)),style:ElevatedButton.styleFrom(primary:Color.fromRGBO(30, 223, 212, 1),fixedSize: const Size(
                        200,
                        30,),),
                          onPressed: () {Navigator.push(
                    ...
                    PopupMenuItem<int>(
                      value: 5,
                      child: ElevatedButton(child: const Text("Delete Pool manager",
                          style:TextStyle(color:Colors.black)),style:ElevatedButton.styleFrom(primary:Color.fromRGBO(30, 223, 212, 1),fixedSize: const Size(
                        200,
                        30,),),
                          onPressed: () async {get_manager_details();await Future.delayed(const Duration(seconds:2));print(mid);print(mname);
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder:
                                (context) => Manager(mid,mname)),)
                          ;}
                      ),
                    ),
                    PopupMenuItem<int>(
